...
export function BornThisMonthCard({
  user,
  onPrevious,
  onNext,
}: BornTodayCardProps) {
        ...
        <Box
          ...
          {user ? (
            <>
              ...
              <Typography
                variant="subtitle2"
                sx={{ mb: "0.5vw", fontWeight: "bold", color: "black" }}>
                İyi ki doğdun!
              </Typography>
              <Typography
                variant="subtitle2"
                sx={{ mb: "0.5vw", color: "red", fontWeight: "bold" }}>
                {`${user.name} ${user.surname}`}
              </Typography>
              <Typography
                color="textSecondary"
                noWrap
                sx={{ mb: "0.5vw", color: "black" }}>
            ...
            <>
              <Typography
                variant="h6"
                sx={{ fontSize: "1.2vw", color: "gray", fontWeight: "bold" }}>
              ...
              <Typography
                ...
                fontWeight="bold"
                color="black"
                sx={{ fontSize: "1vw", mt: "2vw", fontWeight: "bold" }}>
                {currentDate}
              </Typography>
            </>
          )}
